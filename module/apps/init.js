...
export const moduleKey = 'twd'; // Module name. Important that this one is the exact same as the name of the module
export const adventurePack = 'twd.alien-rpg-system';
